...
const injectCSS = () => {
  ...
  s.textContent = `
    ...
    .ks-vtopic.active .ks-vtopic-icon {
      background: var(--ks-bg4);
    }
    ...
    .ks-vtopic:hover .ks-vtopic-action {
      background: rgba(74,222,128,0.18);
      border-color: rgba(74,222,128,0.35);
    }
    .ks-vtopic.active .ks-vtopic-action {
...
const VIDEO_LIBRARY = [
  {
    ...
    icon: "🌿",
    tags: ["rubber", "income"],
    src: "/videos/Tapping_into_profits.mp4",
    available: true,
  ...
  },
  {
    ...
    src: "/videos/Coconut_Diseases__A_Guide.mp4_.mp4",
    available: true,
  ...
  },
  {
    ...
    icon: "🏛️",
    tags: ["scheme", "govt"],
    src: "/videos/Farmer_Assistance__A_Guide.mp4",
    available: true,
  ...
  },
  {
    ...
    icon: "🌾",
    tags: ["paddy", "pest"],
    src: "/videos/protect_your_paddy_cultivation.mp4",
    available: true,
  ...
  },
  {
    ...
    icon: "🌱",
    tags: ["soil", "pH"],
    src: "/videos/Soil_Health_Card_Guide.mp4",
    available: true,
  ...
  },
  {
    ...
    icon: "💧",
    tags: ["water", "drip"],
    src: "/videos/Summer_smart_irrigation_in_Kerala.mp4",
    available: true,
  ...
  },
  {
    ...
    icon: "🚀",
    tags: ["modern", "tech"],
    src: "/videos/The_future_of_agriculture_in_Kerala.mp4",
    available: true,
  ...
  },
  {
    ...
    icon: "🍌",
    tags: ["banana", "harvest"],
    src: "/videos/A_guide_to_a_bountiful_banana_harvest.mp4",
    available: true,
...
export default function Chatbot() {
  ...
  const [messages, setMessages]       = useState([{ id:0, role:"bot", text:WELCOME[lang] || WELCOME.en, ts:fmtTime() }]);
